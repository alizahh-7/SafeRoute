...
export default function RoadDamageImage({ src, alt, className = "", children }: Props) {
  ...
  return <>
    ...
    {open && <div role="dialog" aria-modal="true" aria-label={alt} className="fixed inset-0 z-[100] flex items-center justify-center bg-black/85 p-4" onClick={() => setOpen(false)}>
